...
import time
import logging
from data.data_fetcher import fetch_klines, TOP_SYMBOLS
from core.core_analyzer import Analyzer

logger = logging.getLogger("yjcrypto-scanner")
...
class CryptoScanner:
    ...
    def scan_market(self, max_coins: int = 30, timeframes: list = None) -> list:
        ...
        try:
            from core.core_regime import get_cached_regime, get_min_strength_for_regime
