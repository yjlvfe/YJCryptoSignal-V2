...
logger = logging.getLogger("yjcrypto-heat")

HEAT_FILE = Path("/root/.yjcryptosignal-bot/portfolio_heat.json")
...
LIFECYCLE_FILE = Path("/root/.yjcryptosignal-bot/trade_lifecycle.json")
